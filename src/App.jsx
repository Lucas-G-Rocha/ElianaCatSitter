        ...
        <main className='w-full h-full mt-20'>
          <section className="flex flex-row justify-center w-full items-center scroll-mt-15" id='inicio'>
            <div className='flex flex-col flex-1 justify-center ml-4 gap-y-4'>
              ...
              <a href="https://wa.me/5581984216699" target='_blank' className="bg-[#FBFF29] rounded-[5px] px-2 max-w-fit py-1">Vamos Conversar!</a>
            </div>
          ...
          <section className='pt-20 flex flex-col gap-y-4 items-center max-w-9/10 mx-auto'>
            <h1 className='text-2xl text-center'>Sobre meu <span className='text-[#D15511]'>Trabalho</span></h1>

            <h3 className='text-[16px] text-center'>Vai viajar?</h3>
            <p className='text-[14px] text-center -mt-2 max-w-[350px]'>Viaje tranquilo(a) mantendo a rotina do seu gatinho do jeitinho que ele já conhece! Vou até a sua casa e cuido dele com todo carinho na sua ausência.</p>

            <div className='bg-[#D15511] w-full rounded-[15px] p-4 text-center flex flex-col gap-y-2 justify-between'>
              <h3 className='text-[14px] text-white'>Visitas</h3>
              <p className='text-[12px] text-white'>Até duas visitas por dia, com duração mínima de 1 hora</p>
            </div>
            <div className='bg-[#D15511] w-full rounded-[15px] p-4 text-center flex flex-col gap-y-2 justify-between'>
              <h3 className='text-[14px] text-white'>Medicamentos</h3>
              <p className='text-[12px] text-white'>Administração de medicação sob prescrição do médico veterinário.</p>
            </div>
            <div className='bg-[#D15511] w-full rounded-[15px] p-4 text-center flex flex-col gap-y-2 justify-between'>
              <h3 className='text-[14px] text-white'>Unhas (adicional)</h3>
              <p className='text-[12px] text-white'>Corte de unhas feito de forma segura e confortável.</p>
            </div>
            <div className='bg-[#D15511] w-full rounded-[15px] p-4 text-center flex flex-col gap-y-2 justify-between'>
              <h3 className='text-[14px] text-white'>Contrato</h3>
              <p className='text-[12px] text-white'>Serviços sob contrato, garantindo segurança mútua.</p>
            </div>

            <div className="flex flex-col gap-y-4">
              <h3 className='text-2xl text-center mt-4'>Meus <span className='text-[#D15511]'>Certificados</span></h3>
          ...
          <section className='pt-20 flex flex-col gap-y-4 items-center'>
            ...
            <div className='w-full max-h-400px'>
              ...
              >
                ...
                <SwiperSlide className='flex justify-center items-center'>
                  <img src="/feedback2.jpg" alt="feedback" className="max-h-[400px] ml-auto mr-auto object-contain rounded-xl" />
                </SwiperSlide>
                <SwiperSlide className='flex justify-center items-center'>
                  <img src="/feedback3.jpg" alt="feedback" className="max-h-[400px] ml-auto mr-auto object-contain rounded-xl" />
                </SwiperSlide>
                <SwiperSlide className='flex justify-center items-center'>
                  <img src="/feedback4.jpg" alt="feedback" className="max-h-[400px] ml-auto mr-auto object-contain rounded-xl" />
                </SwiperSlide>
                <SwiperSlide className='flex justify-center items-center'>
                  <img src="/feedback5.jpg" alt="feedback" className="max-h-[400px] ml-auto mr-auto object-contain rounded-xl" />
                </SwiperSlide>
                <SwiperSlide className='flex justify-center items-center'>
                  <img src="/feedback6.jpg" alt="feedback" className="max-h-[400px] ml-auto mr-auto object-contain rounded-xl" />
                </SwiperSlide>
              </Swiper>
            </div>
          </section>
